...
if( empty( $_SESSION['id_user'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysqli_query($con, "UPDATE transaksi SET jenis='$jenis', nama='$nama', bayar='$bayar', kembali='$kembali', total='$total', tanggal=NOW(), id_user='$id_user' WHERE id_transaksi='$id_transaksi'");
		...
		$sql = mysqli_query($con, "SELECT * FROM transaksi WHERE id_transaksi='$id_transaksi'");
...
<form method="post" action="" class="form-horizontal" role="form">
	<div class="form-group">
		...
		<div class="col-sm-3">
			<input type="text" class="form-control" id="nomor_nota" value="<?php echo $row['nomor_nota']; ?>"name="nomor_nota" placeholder="No. Nota" readonly>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-3">
			...
			<?php
				...
				$q = mysqli_query($con, "SELECT jenis FROM biaya");
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			<button type="submit" name="submit" class="btn btn-success" style="background: #bbb581;">Simpan</button>
