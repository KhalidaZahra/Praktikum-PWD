...
if( empty( $_SESSION['id_user'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysqli_query($con, "UPDATE biaya SET jenis='$jenis', biaya='$biaya' WHERE id_biaya='$id_biaya'");
		...
		$sql = mysqli_query($con, "SELECT * FROM biaya WHERE id_biaya='$id_biaya'");
		while($row = mysqli_fetch_array($sql)){

?>
<h2>Edit Data Biaya Jasa</h2>
<hr>
<form method="post" action="" class="form-horizontal" role="form">
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			<button type="submit" name="submit" class="btn btn-success" style="background: darksalmon;">Simpan</button>
			<a href="./admin.php?hlm=biaya" class="btn btn-danger" style="background: mediumorchid;">Batal</a>
		</div>
	</div>
</form>
<?php
